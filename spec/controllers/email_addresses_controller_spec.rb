...
RSpec.describe EmailAddressesController, type: :controller do
  ...
  let(:valid_attributes) {
    { address: "jasonpilz@gmail.com", contact_id: 2, contact_type: 'Person' }
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      let(:valid_attributes) { {address: 'bob@gmail.com', contact_id: bob.id, contact_type: 'Person' } }
      ...
      it "redirects to the created email_address" do
        ...
        valid_attributes = {address: 'bob@gmail.com', contact_id: bob.id, contact_type: 'Person' }
        post :create, {:email_address => valid_attributes}, valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      let(:bob) { Person.create(first_name: 'Bob', last_name: 'Jones') }
      let(:valid_attributes) { { address: 'bob@gmail.com', contact_id: bob.id, contact_type: 'Person' } }
      let(:new_attributes) { { address: "bobthegamer@gmail.com", contact_id: bob.id, contact_type: 'Person' } }
